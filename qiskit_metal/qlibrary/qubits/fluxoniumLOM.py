...
class FluxoniumPocket(BaseQubit):
    ...
    Default Options:
        ...
        * pad_width: '30um' -- The width (x-axis) of the rectangle part of the charge island pads
        * pad_height: '300um' -- The width (y-axis) of the rectangle part of the charge island pads
        * pad_radius: '80um' -- Radius of the circle at the end of the pads
        * l_width: '2um' -- Width of the kinetic inductor along the x-axis
        * l_length: '50um' -- Length of the kinetic inductor along the y-axis
        * l_arm_width = '2um' -- Width of the arm of the kinetic inductor along the y-axis
        * l_arm_length: '60um' -- Length of the arm of the kinetic inductor along x-axis
        * L_j: '16.35nH' -- Kinetic inductance 
    ...
    def make_pocket(self):
        ...
        l_arm_bot = draw.Polygon([
            (pad_width/2, -(l_length/2+l_arm_width)), # point e
            (l_arm_length, -(l_length/2+l_arm_width)), # point f
            (l_arm_length, -l_length/2), # point g
            (pad_width/2, -l_length/2), # point h
            ])
