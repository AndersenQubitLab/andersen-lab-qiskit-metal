...
class FluxoniumPocket(BaseQubit):
    ...
    Default Options:
        ...
        * l_inductance: '200nH' -- Targetted kinetic energy for the inductor
        * l_ind_per_square: '2nH' -- The kinetic energy per square
        * L_j: '34.38nH' -- Calculated by E_j = 4.75 GHz
    ...
    default_options = Dict( 
        chip='main',
        pad_gap='30um',
        jj_width='2um', #don't change this value
        jj_length='10um',
        jj_orientation='1',
        ...
        l_arm_width = '2um',
        l_arm_length='20um',
        l_inductance='100nH', #targetted E_L value is 0.8 GHz
        l_ind_per_square='2nH',
        L_j = '34.38nH', #targetted E_J value is 4.75 GHz
        pocket_width='900um',
        pocket_height='550um',
    ...
    def make_pocket(self):
      ...
      #  rect_jj = draw.rectangle(jj_width, jj_width/2, -pad_width/16, pad_gap/12)
        rect_jj = draw.LineString([(-pad_width/16*jj_o, -jj_length/10), 
                                   (jj_width*jj_o, -jj_length/10)])
